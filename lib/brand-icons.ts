...
const BRAND_ICONS: { name: string; aliases?: string[]; color: string }[] = [
  ...
  { name: "x-twitter", aliases: ["x"], color: "#000000" },
  ...
  { name: "signal-messenger", aliases: ["signal"], color: "#3A76F0" },
  ...
  { name: "adobe", aliases: ["adobecreativecloud", "creativecloud", "adobecc"], color: "#FF0000" },
